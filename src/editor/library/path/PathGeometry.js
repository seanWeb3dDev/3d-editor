...
class PathGeometry extends THREE.BufferGeometry {
  ...
  _updateAttributes(position,normal,uv,uv2,indices) {
    ...
    positionAttribute.addUpdateRange.count = position.length;
    ...
    if (uv2) {
      ...
      uv2Attribute.addUpdateRange.count = uv2.length;
